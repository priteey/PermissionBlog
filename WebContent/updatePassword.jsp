...
<td height=60px>
               <div style="color:white; font-weight:bold">Current Password:</td><td><input type="password"  style="height:30px; font-weight:bold" name="currentpassword"  placeholder="current password" /></div>
                ...
                <tr>
                <td height=60px>
               	<div style="color:white; font-weight:bold">New Password:</td><td><input type="password" style="height:30px; font-weight:bold" name="password"  placeholder="new password"  /><div style="color:white;width:40%; font-size:80%">(Minimum 8 characters at least 1 Uppercase Alphabet, 1 Lowercase Alphabet, 1 Number and 1 Special Character)</div></div>
                </td></tr>
             	<td height=60px>
               	<div style="color:white; font-weight:bold">Confirm Password:</td><td><input type="password" style="height:30px; font-weight:bold" name="confirmPassword"  placeholder="confirm password" /></div>
                </td></tr>
