...
<div class="w3-sidebar w3-bar-block w3-dark-grey w3-animate-left" style="display:block" id="mySidebar">
  ...
  <a href="AdminController?action=update" style="background-color:#1ec7e0" class="w3-bar-item w3-button">Update Organization Profile</a>
                                            ...
                                            <c:forEach var="e" items="${allEmpList}">
                                                <tr>
                                                    ...
                                                    <td><c:out value="${e.bonus}" /></td>
                                          			...
                                          			<td><a href="<%=request.getContextPath() %>/AdminController?action=updateProfile&userId=${e.userId}&divisionName=${e.divisionName}&role=${e.role}&salary=${e.salary}&supervision=${e.supervision}">Update</a></td>
                                           </tr>
                                                </c:forEach>
                                        </table>
                                        </div>
