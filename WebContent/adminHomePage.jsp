...
<%-- <div style="color:blue; background-color:pink;">${UserLoginErr}</div>
 --%><div class="w3-sidebar w3-bar-block w3-dark-grey w3-animate-left" style="display:block" id="mySidebar">
  <a class="w3-bar-item w3-button w3" style="background-color:#1ec7e0" href="AdminController?action=active">View Active Employees</a>
  ...
  <table class="w3-table-all w3-card-4">
    <thead>
      <tr>
                                            ...
                                            <c:forEach var="e" items="${activeEmpList}">
                                                <tr>
                                                    ...
                                                    <td><c:out value="${e.role}" /></td>
                                          			<td><a href="<%=request.getContextPath() %>/AdminController?action=deleteActive&userId=${e.userId}">Delete</a></td>
                                           </tr>
                                                </c:forEach>
                                        </table>
                                        </div>
