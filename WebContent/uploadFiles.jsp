...
<a class="w3-bar-item w3-button w3"  href="EmployeeController?action=profile">View Profile</a>
 <a href="EmployeeController?action=leaves"  class="w3-bar-item w3-button">Request Leaves</a>
  <a href="DirectoryController?action=upload" style="background-color:#1ec7e0" class="w3-bar-item w3-button">Upload Files</a>
...
<table  align="center" width=35% style="margin-left:100px" > 
                ...
                <c:forEach var="d" items="${directoriesList}">
                  <option value="${d.directoryId}">${d.directoryName}</option></c:forEach>
                </select></div>
                </td>
                <tr>
                <td height=60px>
               	<div style="color:white; font-weight:bold"><font color="red">*</font>File Name :</td><td><input type="text" style="height:30px; font-weight:bold" name="fileName" placeholder="file name" /></div>
                </td></tr> 
  				<tr>
                <td height=60px>
               	<div style="color:white; font-weight:bold"><font color="red">*</font>Select file to upload :</td><td><input type="file" style="height:30px; font-weight:bold" name="file"  /></div>
                </td></tr> 
                </table>
                <input type="submit" style="height:40px; width:95px; border-radius:8px; font-weight:bold; font-size:15px; margin-left:350px;margin-top:30px" value="Upload" name ="action"/>
</div>
</form>
<form>
 <div align="center">
