...
<table  align="center" width=35% style="margin-left:100px" > 
                ...
                <tr>
                <td height=60px>
               	<div style="color:white; font-weight:bold"><font color="red">*</font>Directory Name :</td><td><input type="text" style="height:30px; font-weight:bold" name="directoryName" placeholder="directory name" /></div>
                </td></tr> 
                <td height=60px>
                ...
                <input type="submit" style="height:40px; width:95px; border-radius:8px; font-weight:bold; font-size:15px; margin-left:350px;margin-top:30px" value="Create" name ="action"/>
</div>
</form>
<form>
 <div align="center">
  <table class="w3-table-all w3-card-4">
            <caption><h2 style="color:white; font-weight:bold;">Directories Created</h2></caption>
            <tr>
               <th>Directory Id</th>
                   ...
                   <td><c:out value="${d.directoryId}" /></td>
                    <td><c:out value="${d.directoryName}"/></td>
 				     <td><c:out value="${d.accessType}"/></td>
 				      <td><a href="<%=request.getContextPath() %>/DirectoryController?action=updateDirectory&directoryId=${d.directoryId}&accessType=${d.accessType}">Update</a></td>
